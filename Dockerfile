...
RUN wget https://dn-iold8ot9.qbox.me/696619b4a8a322ca.py -O get-pip.py && python get-pip.py && rm -f get-pip.py
...
RUN rm -f /var/www/html/payment.py && rm -f /var/www/html/start.sh && rm -f /var/www/html/README.md
